-- Ultimate fix for admin_get_all_users_detailed function
-- Replace up.is_active with license status logic
...
-- Add comment
COMMENT ON FUNCTION admin_get_all_users_detailed(TEXT, TEXT, TEXT, INTEGER, INTEGER) IS 'Retorna lista detalhada de usuários para super administradores. Usa status de licença ativa ao invés de up