...
COMMENT ON FUNCTION public.hard_delete_service_order IS 'Permite que administradores e proprietários excluam permanentemente ordens de serviço da lixeira';