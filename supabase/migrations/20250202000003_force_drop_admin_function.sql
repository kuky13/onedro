...
-- Add comment
COMMENT ON FUNCTION admin_get_all_users_detailed(TEXT, TEXT, TEXT, INTEGER, INTEGER) IS 'Retorna lista detalhada de usuários para super administradores. Usa status de licença ativa ao invés de up.is_active.';