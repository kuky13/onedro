...
-- This migration corrects the issue where edit forms show empty data
...
COMMENT ON FUNCTION public.get_optimized_budgets(uuid, text, text, integer, integer) IS 'Returns optimized budget data with ALL fields needed for editing forms';