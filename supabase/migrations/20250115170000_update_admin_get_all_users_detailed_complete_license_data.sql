...
-- Add comment
COMMENT ON FUNCTION admin_get_all_users_detailed(text, text, integer, integer) IS 'Get all users with complete license information for admin panel - includes all license table