-- Add sequential_number to get_deleted_service_orders function
-- This migration updates the function to include sequential_number in the returned data

-- Drop existing function
DROP FUNCTION IF EXISTS public.get_deleted_service_orders();

-- Recreate with sequential_number included
...
COMMENT ON FUNCTION public.get_deleted_service_orders() IS 'Retorna ordens de serviço excluídas com sequential_number. Usuários veem apenas suas próprias, admins veem todas.';