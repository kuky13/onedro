...
export const AVAILABLE_PROVIDERS: ProviderInfo[] = [
  ...
  },
  {
    ...
    models: [
      { id: 'gemini-3.1-pro-preview', name: 'Gemini 3.1 Pro (Preview)', description: 'Mais avançado, raciocínio e código (Novo)' },
      { id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash (Preview)', description: 'Performance de fronteira, custo baixo' },
      { id: 'gemini-3.1-flash-lite-preview', name: 'Gemini 3.1 Flash-Lite (Preview)', description: 'Ultra rápido e econômico (Novo)' },
      { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', description: 'Rápido e eficiente (Estável)' },
      { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', description: 'Alta performance (Estável)' },
      { id: 'gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash-Lite', description: 'Mais barato e rápido da família 2.5' },
    ],
    color: 'hsl(217, 91%, 60%)',
  },
];
