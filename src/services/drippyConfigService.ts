...
export const AVAILABLE_PROVIDERS: ProviderInfo[] = [
  {
    ...
    models: [
      ...
      { id: 'google/gemini-2.5-pro', name: 'Gemini 2.5 Pro', description: 'Máxima qualidade' },
  ...
  },
  {
    ...
    models: [
      { id: 'deepseek-chat', name: 'DeepSeek Chat', description: 'Conversação geral' },
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'gemini-1.5-pro', name: 'Gemini 1.5 Pro', description: 'Alta performance' },
      { id: 'gemini-1.5-flash', name: 'Gemini 1.5 Flash', description: 'Rápido e leve' },
    ],
    color: 'hsl(217, 91%, 60%)',
  },
];
