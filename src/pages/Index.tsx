...
const BrandApple = () => (
  <svg viewBox="0 0 170 200" className="h-full w-auto max-h-5 lg:max-h-8 opacity-60" fill="currentColor">
    <path d="M150.4 172.3c-4.5 10.5-9.8 20.2-15.9 29.1-8.3 12.1-15.1 20.5-20.4 25.1-8.1 7.6-16.9 11.5-26.2 11.8-6.7 0-14.8-1.9-24.2-5.8-9.5-3.8-18.2-5.8-26.1-5.8-8.3 0-17.2 2-26.7 5.8-9.5 3.9-17.2 5.9-23 6.1-9 .4-18-3.6-27-12.1-5.7-5-12.8-13.6-21.4-25.8C-69 189.2-76 175.4-81.5 159.8c-5.9-16.8-8.9-33.1-8.9-48.9 0-18.1 3.9-33.7 11.7-46.7 6.1-10.5 14.3-18.8 24.4-24.8 10.1-6.1 21.1-9.2 32.8-9.4 7.1 0 16.4 2.2 28 6.5 11.5 4.4 18.9 6.5 22.1 6.5 2.4 0 10.5-2.5 24.2-7.5 13-4.6 23.9-6.5 32.8-5.7 24.3 2 42.5 11.6 54.6 29.1-21.7 13.2-32.5 31.6-32.3 55.3.2 18.5 6.9 33.9 20.1 46.1 6 5.7 12.6 10 20 13.1-1.6 4.7-3.3 9.1-5.1 13.4zM117.2 10.9c0 14.5-5.3 28-15.8 40.6-12.7 14.9-28.1 23.5-44.7 22.1-.2-1.8-.4-3.7-.4-5.7 0-13.9 6.1-28.8 16.9-41 5.4-6.2 12.2-11.3 20.6-15.3 8.3-4 16.2-6.2 23.6-6.5.2 2 .3 3.9.3 5.8z" transform="translate(85, -25) scale(0.13)"/>
  </svg>
);
