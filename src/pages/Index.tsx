...
const FUNCIONALIDADES = [
  {
    ...
    descricao: "PDF personalizado, WhatsApp com um clique, validade automática.",
  },
  {
    icone: Users,
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur border-b border-border/50">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 lg:px-8 py-3 lg:py-4">
          <Link to="/landing" className="flex items-center gap-2">
            <img alt={name} className="h-7 w-7 lg:h-9 lg:w-9" src={logo} width="36" height="36" loading="eager" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-[10px] lg:text-xs text-muted-foreground/70">CNPJ: 64.797.431/0001-03</p>
            </div>
