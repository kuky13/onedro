...
import { Eye, EyeOff, UserPlus, ArrowLeft, CheckCircle2, AlertCircle, Gift, Mail, AlertTriangle } from 'lucide-react';
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-green-700 dark:text-green-300 text-xs mt-1">
                  Teste todas as funcionalidades do sistema sem compromisso
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <h4 className="font-medium text-amber-800 dark:text-amber-200 text-xs">
                        Verifique sua caixa de spam
                      </h4>
                    </div>
                    <p className="text-amber-700 dark:text-amber-300 text-xs leading-relaxed">
                      Os códigos de confirmação podem ir para a pasta de spam. 
                      Verifique todas as pastas do seu email.
                    </p>
                  </div>
                </div>
              </div>
