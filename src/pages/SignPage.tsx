        ...
        <div className="w-full max-w-sm mx-auto space-y-5">
          ...
          <div className="flex items-center justify-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 text-green-600 rounded-full text-sm font-medium">
              <Gift className="w-4 h-4" />7 dias grátis para testar
            </div>
          </div>
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Comece a usar o sistema de orçamentos</p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="bg-background px-3 text-xs text-muted-foreground uppercase">ou com email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {formData.password && (
                <p className={`text-xs ${passwordStrength.color}`}>Senha: {passwordStrength.text}</p>
              )}
            </div>
            ...
            <Button type="submit" className="w-full h-12 text-base font-semibold" disabled={!isFormValid || isLoading}>
          ...
          <div className="space-y-2 pt-2">
            <p className="text-xs text-muted-foreground text-center">Ao criar sua conta você ganha:</p>
