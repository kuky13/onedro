  ...
  const handleCreateUser = async () => {
    ...
    try {
      ...
      showToast(
        ...
        `${userForm.name} foi adicionado ao sistema com licença válida até ${calculateExpirationDate()}. Um email de confirmação foi enviado para o usuário. Se não encontrar o email na caixa de entrada, verifique também a pasta de spam/lixo eletrônico.`
      );
      ...
      <div className="relative z-10 p-4 h-[calc(100dvh-80px)] overflow-auto">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mt-6 text-sm text-muted-foreground">
            <Link to="/verify-licenca" className="font-medium text-primary hover:underline">
              ← Verificar Licença
            </Link>
          </div>
        </div>
