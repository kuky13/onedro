        ...
        <Card className="backdrop-blur-sm bg-card/95 border-primary/20">
          ...
          <CardContent className="space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                Esta Política de Reembolso faz parte dos Termos de Uso do nosso site. Ao contratar nossos serviços ou adquirir nossos produtos, o usuário declara estar ciente e de acordo com as condições abaixo.
              </p>
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium mb-2">8.1 Direito de arrependimento</h3>
                  <p className="text-muted-foreground mb-2">
                    Conforme o artigo 49 do Código de Defesa do Consumidor, em compras realizadas pela internet o usuário pode desistir da contratação no prazo de até 7 (sete) dias corridos, a contar da data da aquisição.
                  </p>
                  <p className="text-muted-foreground">
                ...
                <div>
                  <h3 className="font-medium mb-2">8.2 Reembolsos após o prazo de arrependimento</h3>
                  <p className="text-muted-foreground mb-2">
                    Passado o prazo legal de 7 dias, pedidos de reembolso poderão ser aceitos a critério da empresa, observadas as seguintes condições:
                  </p>
                  <p className="text-muted-foreground mb-2">
                    O valor será devolvido ao usuário descontadas as taxas administrativas cobradas pelo intermediador de pagamento (Mercado Pago), atualmente equivalentes a 4,99% (quatro vírgula noventa e nove por cento) do valor da transação.
                  </p>
                  <p className="text-muted-foreground">
                    O prazo para processamento do reembolso pode variar conforme a forma de pagamento utilizada, podendo levar até 30 dias úteis, dependendo das políticas das operadoras de cartão de crédito e instituições financeiras.
                  </p>
                </div>
                <div>
                  <h3 className="font-medium mb-2">8.3 Forma de reembolso</h3>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                    <li><strong>Cartão de crédito:</strong> o estorno será solicitado diretamente à operadora do cartão e poderá aparecer em até duas faturas subsequentes.</li>
                    <li><strong>PIX ou boleto bancário:</strong> o valor será devolvido diretamente na conta bancária indicada pelo usuário, dentro do prazo informado acima.</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-medium mb-2">8.4 Casos não reembolsáveis</h3>
            ...
            {/* Alterações */}
            <section>
              <h2 className="text-xl font-semibold mb-4">12. Alterações nos Termos</h2>
              <p className="text-muted-foreground">
