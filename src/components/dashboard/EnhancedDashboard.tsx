...
export const EnhancedDashboard = ({ onNavigateTo }: ModernDashboardProps) => {
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          >
            ...
            >
              {/* Revenue Card */}
              <motion.div 
                className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-50 to-green-100/50 dark:from-green-950/20 dark:to-green-900/10 border border-green-200/50 dark:border-green-800/30 p-6 hover:shadow-xl hover:shadow-green-500/10 transition-all duration-300 cursor-pointer"
