...
import { LicenseEditModal } from '../license/LicenseEditModal';
import { LicenseCreateModal } from './LicenseCreateModal';
import { LicenseHistoryModal } from './LicenseHistoryModal';
import { LicenseAssignModal } from './LicenseAssignModal';
import { LicenseRemoveModal } from './LicenseRemoveModal';
...
export const LicenseManagementPanel = () => {
  ...
  const handleRemoveLicense = (license: License) => {
    setSelectedLicense(license);
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuSeparator />
                        {!license.user_id ? (
                          <DropdownMenuItem onClick={() => handleAssignLicense(license)}>
                            <UserPlus className="mr-2 h-4 w-4" />
                            Atribuir a Usuário
                          </DropdownMenuItem>
                        ) : (
                          <DropdownMenuItem onClick={() => handleRemoveLicense(license)}>
