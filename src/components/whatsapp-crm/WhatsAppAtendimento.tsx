...
export function WhatsAppAtendimento() {
  ...
  // Mostrar WebChat se tiver instance_id - mesmo que status ainda nao seja "open"
  // (Evolution pode estar conectado mas o DB ainda nao atualizou via webhook)
      ...
      <Card className="max-w-md mx-auto mt-8">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Va na aba <strong>Conectar</strong> acima e escaneie o QR Code para vincular seu WhatsApp.
          </p>
        </CardContent>
      </Card>
    );
