      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label>Expiração de Licença</Label>
                <p className="text-sm text-muted-foreground">Alertas sobre licenças vencendo</p>
              </div>
              <Switch
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="weak">Fraca (6+ caracteres)</SelectItem>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label>Limite Padrão de Orçamento (R$)</Label>
              <Input
                type="number"
