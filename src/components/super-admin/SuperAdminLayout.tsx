            ...
            {navigationItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  to={item.href}
                  className={cn(
                    'group relative overflow-hidden flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-all duration-300',
                    current
                      ? 'bg-gradient-to-r from-primary/10 to-primary/5 text-primary border border-primary/20 shadow-lg shadow-primary/10'
                      : 'text-muted-foreground hover:bg-background/60 hover:text-foreground hover:shadow-md'
                  )}
                >
                  ...
                  <Icon
                    className={cn(
                      ...
                      current ? 'text-primary' : 'text-muted-foreground group-hover:text-foreground'
                    )}
                  />
