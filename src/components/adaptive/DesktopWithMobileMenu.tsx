  ...
  return (
    ...
    >
      <div className={cn("w-full flex flex-col desktop-main-container", "gap-0 overflow-hidden transition-opacity duration-75")}>
        <header 
          className={cn(
            "flex shrink-0 items-center justify-between border-b sticky top-0 z-40 transition-all duration-100", 
            "desktop-header px-8 py-4 h-20",
            // Enhanced desktop header with consistent height
            "bg-background/98 border-border/50", 
            navHeight, 
            isScrolled ? "shadow-lg bg-background/99" : "shadow-sm bg-background/95"
          )}
        >
        ...
        <main 
          className={cn(
            "flex-1 overflow-y-auto overflow-x-hidden transition-all duration-100", 
            "desktop-main-content bg-muted/20 scroll-smooth",
