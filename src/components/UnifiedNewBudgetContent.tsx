...
import { WormBudgetForm } from './worm/WormBudgetForm';
  ...
  if (showForm) {
    return (
      <div className="min-h-screen p-4">
        <WormBudgetForm 
          budget={copiedBudgetData} 
          onSuccess={handleFormBack} 
          ...
          <CardContent className="space-y-6">
            <div className="text-center py-6">
              ...
              <Button 
                ...
                size="lg" 
                className="shadow-md hover:shadow-lg transition-all duration-300 active:scale-95"
                style={{
          ...
          <CardContent className="space-y-4">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 safari-safe-input safari-safe-blur ios-tap-highlight-none"
                style={{
              ...
              {searchTerm && (
                <Button
                  ...
                  size="sm"
                  onClick={clearSearch}
                  className="absolute right-1 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0 transition-all duration-200 active:scale-95"
                  style={{
                    touchAction: 'manipulation',
                    WebkitTapHighlightColor: 'transparent',
                    WebkitTouchCallout: 'none',
              ...
              <div className="text-center py-8">
                ...
                {hasActiveSearch && (
                  <Button
                    variant="outline"
                    onClick={clearSearch}
                    className="mt-3 transition-all duration-200 active:scale-95"
                    style={{
                      touchAction: 'manipulation',
                      WebkitTapHighlightColor: 'transparent',
                      WebkitTouchCallout: 'none',
