...
import { ArrowLeft, Users, Shield, UserPlus, Settings, Search, Calendar, Trash2, Loader2, Gamepad2, Key, Rocket, AlertTriangle } from 'lucide-react';
...
const AdminLiteComponent = ({
  ...
  const [activeTab, setActiveTab] = useState<'users' | 'licenses' | 'game'>('users');
  ...
  return <div className="h-[100dvh] bg-background flex flex-col">
      ...
      WebkitOverflowScrolling: 'touch'
        ...
        {activeTab === 'licenses' ? <AdminLicenseManagerEnhanced /> : activeTab === 'game' ? <GameSettingsPanel /> : <>
            {/* Create User Button */}
